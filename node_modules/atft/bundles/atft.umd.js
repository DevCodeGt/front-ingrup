(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('three'), require('three/examples/jsm/renderers/CSS3DRenderer'), require('three.meshline'), require('three/examples/jsm/loaders/OBJLoader'), require('three/examples/jsm/loaders/MTLLoader'), require('three/examples/jsm/loaders/SVGLoader'), require('three/examples/jsm/controls/OrbitControls')) :
    typeof define === 'function' && define.amd ? define('atft', ['exports', '@angular/core', '@angular/common', 'three', 'three/examples/jsm/renderers/CSS3DRenderer', 'three.meshline', 'three/examples/jsm/loaders/OBJLoader', 'three/examples/jsm/loaders/MTLLoader', 'three/examples/jsm/loaders/SVGLoader', 'three/examples/jsm/controls/OrbitControls'], factory) :
    (global = global || self, factory(global.atft = {}, global.ng.core, global.ng.common, global.three, global.CSS3DRenderer, global.three_meshline, global.OBJLoader, global.MTLLoader, global.SVGLoader, global.OrbitControls));
}(this, function (exports, core, common, three, CSS3DRenderer, three_meshline, OBJLoader, MTLLoader, SVGLoader, OrbitControls) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AbstractCamera = /** @class */ (function () {
        ...
        AbstractCamera.propDecorators = {
            ...
            positionZ: [{ type: core.Input }],
            zAxisUp: [{ type: core.Input }]
        };
    ...
    */
    ...
    var PerspectiveCameraComponent = /** @class */ (function (_super) {
        ...
        PerspectiveCameraComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{ provide: AbstractCamera, useExisting: core.forwardRef((/**
                                 * @return {?}
                                 */
    ...
    var AbstractObject3D = /** @class */ (function () {
        ...
        AbstractObject3D.propDecorators = {
            childNodes: [{ type: core.ContentChildren, args: [AbstractObject3D, { descendants: false },] }],
            viewChilds: [{ type: core.ViewChildren, args: [AbstractObject3D,] }],
            rotateX: [{ type: core.Input }],
            rotateY: [{ type: core.Input }],
            rotateZ: [{ type: core.Input }],
            translateX: [{ type: core.Input }],
            translateY: [{ type: core.Input }],
            translateZ: [{ type: core.Input }],
    ...
    var AnimationService = /** @class */ (function () {
        function AnimationService(rendererService) {
             ...
             */
            this.animate = new core.EventEmitter();
            this.enabled = false;
    ...
    var MeshLineConnectorComponent = /** @class */ (function (_super) {
        ...
        function () {
            ...
            this.lineMaterial = (this.animated ?
                new three_meshline.MeshLineMaterial({
        ...
        MeshLineConnectorComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [{ provide: AbstractObject3D, useExisting: core.forwardRef((/**
                                 * @return {?}
                                 */
        ...
        MeshLineConnectorComponent.propDecorators = {
            materialColor: [{ type: core.Input }],
            transparent: [{ type: core.Input }],
            opacity: [{ type: core.Input }],
            lineWidth: [{ type: core.Input }],
            depthWrite: [{ type: core.Input }],
            depthTest: [{ type: core.Input }],
            animated: [{ type: core.Input }],
            animationIncrement: [{ type: core.Input }]
        };
    ...
    var ObjLoaderComponent = /** @class */ (function (_super) {
        ...
        function ObjLoaderComponent(rendererService) {
            var _this = _super.call(this, rendererService) || this;
            _this.rendererService = rendererService;
            _this.loader = new OBJLoader.OBJLoader();
            _this.mtlLoader = new MTLLoader.MTLLoader();
            return _this;
        }
        ...
        ObjLoaderComponent.propDecorators = {
            ...
            texturePath: [{ type: core.Input }],
            resourcePath: [{ type: core.Input }]
        };
    ...
    var SVGLoaderComponent = /** @class */ (function (_super) {
        ...
        function SVGLoaderComponent(rendererService) {
            ...
            _this.depthWrite = true;
            _this.centered = true;
            _this.loader = new SVGLoader.SVGLoader();
            return _this;
        }
        ...
        SVGLoaderComponent.propDecorators = {
            overrideMaterialColor: [{ type: core.Input }],
            material: [{ type: core.Input }],
            depthWrite: [{ type: core.Input }],
    ...
    var BoxMeshComponent = /** @class */ (function (_super) {
        ...
        BoxMeshComponent.propDecorators = {
            ...
            widthSegments: [{ type: core.Input }],
            heightSegments: [{ type: core.Input }],
            depthSegments: [{ type: core.Input }]
        };
    ...
    var CylinderMeshComponent = /** @class */ (function (_super) {
        ...
        function () {
            ...
            /** @type {?} */
            var geometry = new three.CylinderGeometry(this.radiusTop, this.radiusBottom, this.height, this.radialSegments, this.heightSegments, this.openEnded, this.thetaStart, this.thetaLength);
            /** @type {?} */
            var material = this.getMaterial();
            /** @type {?} */
            var mesh = new three.Mesh(geometry, material);
        ...
        CylinderMeshComponent.propDecorators = {
            radiusTop: [{ type: core.Input }],
            radiusBottom: [{ type: core.Input }],
            height: [{ type: core.Input }],
            radialSegments: [{ type: core.Input }],
            heightSegments: [{ type: core.Input }],
            openEnded: [{ type: core.Input }],
            thetaStart: [{ type: core.Input }],
            thetaLength: [{ type: core.Input }]
        };
    ...
    var TorusMeshComponent = /** @class */ (function (_super) {
        ...
        TorusMeshComponent.propDecorators = {
            radius: [{ type: core.Input }],
            tube: [{ type: core.Input }],
            radialSegments: [{ type: core.Input }],
            tubularSegments: [{ type: core.Input }],
            arc: [{ type: core.Input }]
        };
    ...
    var AbstractCss3dMesh = /** @class */ (function (_super) {
        ...
        AbstractCss3dMesh.propDecorators = {
            width: [{ type: core.Input }],
            height: [{ type: core.Input }],
            resolutionX: [{ type: core.Input }],
            resolutionY: [{ type: core.Input }]
        };
    ...
    var Css3dVideoMeshComponent = /** @class */ (function (_super) {
        ...
        function () {
            ...
            /** @type {?} */
            var object = new CSS3DRenderer.CSS3DObject(div);
            return object;
        };
        /**
         * @return {?}
    ...
    var TextMeshComponent = /** @class */ (function (_super) {
        ...
        TextMeshComponent.propDecorators = {
            ...
            size: [{ type: core.Input }],
            height: [{ type: core.Input }],
            curveSegments: [{ type: core.Input }],
            bevelEnabled: [{ type: core.Input }],
            bevelThickness: [{ type: core.Input }],
            bevelSize: [{ type: core.Input }],
            bevelOffset: [{ type: core.Input }],
            bevelSegments: [{ type: core.Input }],
            fontUrl: [{ type: core.Input }],
            castShadow: [{ type: core.Input }],
            receiveShadow: [{ type: core.Input }],
            depthWrite: [{ type: core.Input }],
            centered: [{ type: core.Input }]
    ...
    var SceneComponent = /** @class */ (function (_super) {
        ...
        SceneComponent.propDecorators = {
            ...
            fog: [{ type: core.Input }],
            fogColor: [{ type: core.Input }],
            fogNear: [{ type: core.Input }],
            fogFar: [{ type: core.Input }]
        };
    ...
    var RendererCanvasComponent = /** @class */ (function () {
        ...
        RendererCanvasComponent.propDecorators = {
            canvasRef: [{ type: core.ViewChild, args: ['canvas', { static: true },] }],
    ...
    var AbstractOrbitControls = /** @class */ (function () {
        ...
        AbstractOrbitControls.propDecorators = {
            childCameras: [{ type: core.ContentChildren, args: [AbstractCamera, { descendants: true },] }],
            webGlRenderer: [{ type: core.ContentChild, args: [RendererCanvasComponent, { static: false },] }]
        };
    ...
    var OrbitControlsComponent = /** @class */ (function (_super) {
         ...
         */
        function () {
            this.controls = new OrbitControls.OrbitControls(this.childCameras.first.camera, this.listeningControlElement && this.listeningControlElement.nativeElement);
    ...
    var MapControlsComponent = /** @class */ (function (_super) {
        ...
        function () {
            var _this = this;
            this.controls = new OrbitControls.MapControls(this.childCameras.first.camera, this.listeningControlElement && this.listeningControlElement.nativeElement);
            this.controls.rotateSpeed = this.rotateSpeed;
            this.controls.zoomSpeed = this.zoomSpeed;
        ...
        MapControlsComponent.propDecorators = {
            rotateSpeed: [{ type: core.Input }],
            zoomSpeed: [{ type: core.Input }],
            autoRotate: [{ type: core.Input }],
            autoRotateSpeed: [{ type: core.Input }],
            enableDamping: [{ type: core.Input }],
            dampingFactor: [{ type: core.Input }],
            screenSpacePanning: [{ type: core.Input }],
            minDistance: [{ type: core.Input }],
            maxDistance: [{ type: core.Input }],
            maxPolarAngle: [{ type: core.Input }],
            panSpeed: [{ type: core.Input }]
        };
    ...
    var RaycasterGroupDirective = /** @class */ (function () {
        function RaycasterGroupDirective(host, raycasterService) {
            ...
            this.mouseExit = new core.EventEmitter();
        ...
        RaycasterGroupDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[atft-raycaster-group]' },] }
        ];
        /** @nocollapse */
    ...
    var RaycasterCameraDirective = /** @class */ (function () {
        ...
        RaycasterCameraDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[atft-raycaster-camera]' },] }
        ];
        /** @nocollapse */
    ...
    var RaycasterEnableDirective = /** @class */ (function () {
        ...
        RaycasterEnableDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[atft-raycaster-enable]' },] }
        ];
        /** @nocollapse */
    ...
    exports.AtftModule = AtftModule;
    exports.AxesHelperComponent = AxesHelperComponent;
    exports.BoxMeshComponent = BoxMeshComponent;
    exports.Css3dVideoMeshComponent = Css3dVideoMeshComponent;
    exports.CylinderMeshComponent = CylinderMeshComponent;
    ...
    exports.FrameMeshComponent = FrameMeshComponent;
    exports.GridHelperComponent = GridHelperComponent;
    exports.HemisphereLightComponent = HemisphereLightComponent;
    exports.LineConnectorComponent = LineConnectorComponent;
    exports.MapControlsComponent = MapControlsComponent;
    exports.MeshLineConnectorComponent = MeshLineConnectorComponent;
    exports.ObjLoaderComponent = ObjLoaderComponent;
    exports.ObjectLoaderComponent = ObjectLoaderComponent;
    exports.OrbitControlsComponent = OrbitControlsComponent;
    exports.PerspectiveCameraComponent = PerspectiveCameraComponent;
    exports.PlaneMeshComponent = PlaneMeshComponent;
    exports.PointLightComponent = PointLightComponent;
    exports.Rad2DegPipe = Rad2DegPipe;
    exports.RaycasterCameraDirective = RaycasterCameraDirective;
    exports.RaycasterEnableDirective = RaycasterEnableDirective;
    exports.RaycasterGroupDirective = RaycasterGroupDirective;
    exports.RaycasterService = RaycasterService;
    exports.RendererCanvasComponent = RendererCanvasComponent;
    exports.RendererService = RendererService;
    exports.SVGLoaderComponent = SVGLoaderComponent;
    exports.SceneComponent = SceneComponent;
    exports.SphereMeshComponent = SphereMeshComponent;
    exports.StatsService = StatsService;
    exports.TorusMeshComponent = TorusMeshComponent;
    exports.appliedColor = appliedColor;
    exports.appliedMaterial = appliedMaterial;
    exports.calculateSize = calculateSize;
    exports.fixCenter = fixCenter;
    exports.scaleToFit = scaleToFit;
    exports.ɵa = AtftCameraModule;
    exports.ɵb = PerspectiveCameraComponent;
    exports.ɵba = BoxMeshComponent;
    exports.ɵbb = AbstractMesh;
    exports.ɵbc = CylinderMeshComponent;
    exports.ɵbd = FrameMeshComponent;
    exports.ɵbe = PlaneMeshComponent;
    exports.ɵbf = SphereMeshComponent;
    exports.ɵbg = TorusMeshComponent;
    exports.ɵbh = Css3dVideoMeshComponent;
    exports.ɵbi = AbstractCss3dMesh;
    exports.ɵbj = AtftTextModule;
    exports.ɵbk = TextMeshComponent;
    exports.ɵbl = SceneComponent;
    exports.ɵbm = AtftControlModule;
    exports.ɵbn = OrbitControlsComponent;
    exports.ɵbo = AbstractOrbitControls;
    exports.ɵbp = RendererCanvasComponent;
    exports.ɵbq = RaycasterService;
    exports.ɵbr = MapControlsComponent;
    exports.ɵbs = AtftPipeModule;
    exports.ɵbt = Deg2RadPipe;
    exports.ɵbu = Rad2DegPipe;
    exports.ɵbv = AtftRendererModule;
    exports.ɵbw = AtftAnimationModule;
    exports.ɵbx = AtftRaycasterModule;
    exports.ɵby = RaycasterGroupDirective;
    exports.ɵbz = RaycasterCameraDirective;
    exports.ɵc = AbstractCamera;
    exports.ɵca = RaycasterEnableDirective;
    exports.ɵd = RendererService;
    exports.ɵe = AtftObjectModule;
    exports.ɵf = AtftConnectorModule;
    exports.ɵg = LineConnectorComponent;
    exports.ɵh = AbstractConnector;
    exports.ɵi = AbstractObject3D;
    exports.ɵj = MeshLineConnectorComponent;
    exports.ɵk = AnimationService;
    exports.ɵl = AtftHelperModule;
    exports.ɵm = AxesHelperComponent;
    exports.ɵn = EmptyComponent;
    exports.ɵo = GridHelperComponent;
    exports.ɵp = AtftLightModule;
    exports.ɵq = DirectionalLightComponent;
    exports.ɵr = HemisphereLightComponent;
    exports.ɵs = PointLightComponent;
    exports.ɵt = AtftLoaderModule;
    exports.ɵu = ObjLoaderComponent;
    exports.ɵv = AbstractModelLoader;
    exports.ɵw = AbstractLazyObject3D;
    exports.ɵx = ObjectLoaderComponent;
    exports.ɵy = SVGLoaderComponent;
    exports.ɵz = AtftMeshModule;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=atft.umd.js.map
