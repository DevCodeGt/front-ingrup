...
export class TablesDataComponent implements OnInit {
  ...
  constructor(
   ...
   CAMBIAR_L(lang)
   {
    ...
    //console.log('descripcion', this.descripcion_BK);
    console.log('tsd DES',this.selectedData.descripcion);
    var DESC = this.selectedData.descripcion;
    //console.log('DES',DESC);
     if (lang == 'en')
     {
       if (DESC){
      let foo = this.translate.instant(DESC);
      this.selected.nombre = foo;
      //console.log('TRADUCCION',foo);
      //this.selectedData.descripcion = foo;
      }
     }
     else
     {
      //this.selectedData.descripcion = this.descripcion_BK;
      this.selected.nombre = this.descripcion_BK;
     }
    }
   }
  ...
  ngOnInit() {
    ...
    if(this.selectedData.presentaciones){
        ...
        ////
        this.descripcion_BK = this.selected.descripcion;
